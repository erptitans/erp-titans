        ...
        <div className="space-y-12">
          ...
          <section>
            ...
            <ul className="list-none space-y-3 mb-4">
              <li className="flex items-start">
                ...
                <span className="text-[#5A6B85] leading-relaxed">Fill out our contact or inquiry forms</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Schedule an ERP Health Audit or consultation</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Communicate with us via email or phone</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Request resources or whitepapers</span>
              </li>
            </ul>
            <p className="text-[#5A6B85] leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-none space-y-3">
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Provide, operate, and maintain our services</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Process your inquiries and schedule consultations</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Send you meeting invites and follow-up communications</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Analyze and improve our website and service offerings</span>
              </li>
              <li className="flex items-start">
                <span className="w-1.5 h-1.5 rounded-full bg-[#003D82] mt-2.5 mr-3 shrink-0"></span>
                <span className="text-[#5A6B85] leading-relaxed">Comply with legal obligations</span>
              </li>
            </ul>
          </section>

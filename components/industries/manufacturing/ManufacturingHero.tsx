        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-[40px] md:text-[56px] font-[800] text-[#003D82] tracking-tight leading-[1.05]">
              Precision ERP for <br className="hidden sm:block" />
          ...
          >
            ...
            >
              <div className="w-12 h-12 rounded-full bg-[#003D82]/5 text-[#003D82] flex items-center justify-center shrink-0">
                <BarChart2 size={24} strokeWidth={2} />
              </div>
              <div className="flex flex-col">
                <p className="text-[28px] font-[800] text-[#003D82] leading-none mb-1">35%</p>
                <p className="text-[#64748B] text-[10px] font-bold uppercase tracking-wider">Efficiency Boost</p>
              </div>
            </motion.div>

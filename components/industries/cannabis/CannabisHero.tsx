...
export default function CannabisHero() {
  return (
    <section className="relative pt-32 lg:pt-36 pb-[80px] bg-[#F8FAFC] overflow-hidden flex items-center min-h-[calc(100vh-100px)]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div className="absolute top-[20%] -right-[10%] w-[40%] h-[40%] rounded-full bg-green-50/50 blur-[100px]" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-[40px] md:text-[56px] font-[800] text-[#003D82] tracking-tight leading-[1.05]">
              Seed-to-Sale <br className="hidden sm:block" />
          ...
          >
            ...
            >
              <div className="w-12 h-12 rounded-full bg-green-50 text-[#16A34A] flex items-center justify-center shrink-0">
                <ShieldCheck size={24} strokeWidth={2} />
              </div>
              <div className="flex flex-col">
                <p className="text-[28px] font-[800] text-[#003D82] leading-none mb-1">100%</p>
                <p className="text-[#64748B] text-[10px] font-bold uppercase tracking-wider">Audit Ready</p>
              </div>
            </motion.div>
